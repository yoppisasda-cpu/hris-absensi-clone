  ...
  <section className="hero-section">
    <div className="hero-content">
      ...
      <div className="store-badges" style={{ display: 'flex', justifyContent: 'center', gap: '1rem', marginTop: '2rem' }}>
        <a href="#" style={{ display: 'inline-block', transition: '0.3s all' }}>
          <img src="https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg" alt="Get it on Google Play" style={{ height: '45px' }} />
        </a>
        <a href="#" style={{ display: 'inline-block', transition: '0.3s all' }}>
          <img src="https://upload.wikimedia.org/wikipedia/commons/3/3c/Download_on_the_App_Store_Badge.svg" alt="Download on the App Store" style={{ height: '45px' }} />
        </a>
      </div>
    </div>
  </section>
