        ...
        <DashboardLayout>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Kelola indikator kinerja dan berikan penilaian berkala bagi karyawan.</p>
                </div>
            </div>
                        ...
                        <div className="flex gap-4 w-full md:w-auto">
                            <div className="relative flex-1 md:w-64">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2 border border-slate-200 dark:border-slate-700 rounded-lg text-sm text-slate-900 dark:text-white dark:bg-slate-800 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                />
                            </div>
                            <div className="flex gap-2">
                                <select
                                    className="border border-slate-200 dark:border-slate-700 rounded-lg px-3 py-2 text-sm text-slate-900 dark:text-white dark:bg-slate-800 focus:outline-none"
                                    value={selectedMonth}
