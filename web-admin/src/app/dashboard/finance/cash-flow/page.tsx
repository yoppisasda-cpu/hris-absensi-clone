        ...
        <DashboardLayout>
            <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button className="flex items-center gap-2 rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-emerald-100 hover:bg-emerald-700 active:scale-95 transition-all">
            ...
            <div className="mb-8 flex flex-wrap items-center gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <div className="flex items-center gap-2 text-emerald-600">
                    <Calendar className="h-4 w-4" />
                    <span className="text-sm font-bold uppercase tracking-tight">Pilih Periode:</span>
                </div>
                <select 
                    value={month} 
                    onChange={(e) => setMonth(parseInt(e.target.value))}
                    className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-1.5 text-sm font-bold text-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                >
                    {months.map((m, i) => (
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-lg overflow-hidden mb-12">
                ...
                <table className="w-full border-collapse text-left">
                    <tbody className="divide-y divide-slate-100 italic">
                        ...
                        {Object.entries(data?.outflow.categories || {}).length > 0 ? (
                            ...
                            <tr>
                                <td className="px-10 py-3 text-xs text-slate-400">Tidak ada pengeluaran tunai tercatat</td>
                                <td></td>
                            </tr>
                        )}
