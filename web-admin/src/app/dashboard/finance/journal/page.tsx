...
export default function JournalPage() {
    ...
    const handleExportExcel = async () => {
        try {
            ...
            link.href = url;
            link.setAttribute('download', `Jurnal_Umum_${new Date().toISOString().split('T')[0]}.xlsx`);
    ...
    return (
        <DashboardLayout>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-8 border-t border-slate-200 print:hidden">
