            ...
            <div className="p-0 space-y-6 animate-in fade-in duration-500 overflow-y-auto max-h-[90vh]">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-black italic tracking-tight text-slate-900 uppercase">Buku Hutang (Payables)</h1>
                            <p className="text-sm text-slate-500 font-medium">Lacak semua pengeluaran tempo yang belum dibayar ke Supplier.</p>
                        </div>
                    </div>
                    <div className="bg-red-50 px-6 py-3 rounded-2xl border border-red-100 text-right">
                        ...
                        <p className="text-2xl font-black text-red-600">Rp {totalHutang.toLocaleString()}</p>
                    </div>
                </div>
