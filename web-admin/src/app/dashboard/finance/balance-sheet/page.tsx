...
import { Landmark, Wallet, ShieldCheck, Scale, FileText, Download, Printer, AlertCircle, Info } from "lucide-react";
        ...
        <DashboardLayout>
            <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex gap-2">
                    ...
                    <button className="flex items-center gap-2 rounded-xl bg-blue-600 px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-blue-100 hover:bg-blue-700 active:scale-95 transition-all">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                ...
                <div className="space-y-6">
                    <div className="flex items-center justify-between px-2">
                        <h2 className="text-lg font-black text-slate-900 border-b-2 border-blue-600 pb-1">AKTIVA (ASET)</h2>
                    </div>
                    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                        <table className="w-full">
                            ...
                            <tbody className="divide-y divide-slate-100 italic">
                                <tr>
                                    <td className="px-6 py-3 font-black text-slate-900 text-xs tracking-wider uppercase bg-blue-50/30 not-italic">ASET LANCAR</td>
                                    <td></td>
                                </tr>
                                ...
                                <tr className="bg-blue-600">
                                    <td className="px-6 py-4 font-black text-white text-sm uppercase tracking-tighter not-italic">TOTAL AKTIVA</td>
                    ...
                    <div className="p-4 rounded-xl bg-blue-50/50 flex gap-3 items-start border border-blue-100">
                        ...
                        <p className="text-[11px] font-medium text-slate-500 italic">
                            Aset Lancar mencakup seluruh saldo kas, bank, dan rekening giro yang dikelola di modul Kas & Bank perusahaan.
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="p-4 rounded-xl bg-indigo-50/50 flex gap-3 items-start border border-indigo-100">
                        <Landmark className="h-4 w-4 text-indigo-500 mt-0.5" />
                        <p className="text-[11px] font-medium text-slate-500 italic">
                            Kewajiban dihitung berdasarkan tagihan/pengeluaran Tempo yang belum dilunasi. Modal otomatis menyesuaikan berdasarkan selisih aset dan hutang.
                        </p>
                    </div>
                </div>
            </div>
