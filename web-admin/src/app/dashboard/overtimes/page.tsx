    ...
    return (
        <DashboardLayout>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-white">Manajemen Lembur (Overtime)</h1>
                    <p className="text-sm text-slate-400">Tinjau dan setujui pengajuan lembur karyawan.</p>
                </div>
